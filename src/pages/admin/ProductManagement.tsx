...
const ProductsManagement = () => {
  ...
  const fetchCategories = async () => {
    try {
      // You'll need to create a category service
  ...
  try {
    ...
    // Refresh the entire product list to get latest data
    await fetchProducts();
  } catch (err: any) {
                ...
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-sm text-gray-900">{product.rating || 'N/A'}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
